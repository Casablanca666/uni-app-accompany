  ...
  setup(__props) {
    ...
    const toMap = () => {
      ...
      common_vendor.index.navigateTo({
        url: "plugin://routerPlan/index?key=" + key + "&referer=" + referer + "&endPoint=" + endPoint + "&navigation=1"
      });
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/workspace/uni-app/uni-app-company/pages/hospital/index.vue"]]);
