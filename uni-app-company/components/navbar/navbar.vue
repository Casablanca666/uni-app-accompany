		...
		<view v-if="isHome" class="headNav" :style="'height:'+navHeight+'rpx;line-height:'+navHeight+'rpx;padding-left:20rpx;'">
			...
			<view style="flex:1">
				<navigator url="/pages/search/index"
				 :style="'height:'+menu.height*2+'rpx;line-height:'+menu.height*2+'rpx;margin-top:'+(menu.top*2-statusHeight)
				 +'rpx;margin-left:32rpx;margin-right:'+(menu.width*2+24)+'rpx;background:#f4f4f4;border-radius:200rpx;text-align:center'"
				>
...
import { ref,reactive,defineProps,onBeforeMount,defineEmits } from 'vue'
	//状态栏高度
